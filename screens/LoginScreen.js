...
export default class LoginScreen extends Component {
  ...
  //carrega fontes assincronas
  //recebe uma espera de loadAsync
  //e setamos o state  fontsLoaded para true
  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        behaviour: "web",
        androidClientId:
          "809565779293-h4k68knqalc4ikoh9mu2nk9jd0o9p42c.apps.googleusercontent.com",
        iosClientId:
          "809565779293-01nlf5ch2o5vudrtcofl2jb6iok0e4q2.apps.googleusercontent.com",
